...
processor.prototype.extractMetaData = function () {
    ...
    for (metaIndex = 0; metaIndex < 3; metaIndex++) {
        ...
        if (metaIndex === 0) {
            ...
            for (bufferIndex = spos; bufferIndex < npos; bufferIndex++) {
                val = val * 10 + buffer[bufferIndex] - 48;
            }
        }
...
processor.prototype.onDataReceived = function (data) {
    ...
    callBuffer = this.buffer.slice(0, 5);
